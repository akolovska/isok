...
class InvoiceController extends Controller
{
    ...
    public function store(InvoiceStoreRequest $request)
    {
        ...
        return redirect()->route('invoices/index.php')->with('success', 'Invoice added successfully');
    }
    ...
    public function update(InvoiceUpdateRequest $request, Invoice $invoice)
    {
        ...
        return redirect()->route('invoices/index.php')->with('success', 'Invoice edited successfully');
    }
    ...
    {
        $invoice->delete();
        return redirect()->route('invoices/index.php')->with('success', 'Invoice deleted successfully');
